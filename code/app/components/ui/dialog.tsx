 ...
 * Basato su @radix-ui/react-dialog (già in package.json).
 *
 * Accessibility: WCAG 2.2 AA
 * - role="dialog" e aria-modal="true" gestiti da Radix
 * - Focus trap automatico all'apertura
 * - Chiusura con Escape gestita da Radix
 * - aria-labelledby / aria-describedby legati a DialogTitle / DialogDescription
 */
