 ...
 * Basato su @radix-ui/react-select (già in package.json).
 *
 * Accessibility: WCAG 2.2 AA
 * - Keyboard navigation gestita da Radix
 * - aria-required / aria-invalid passati via props
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-input flex h-9 w-full items-center justify-between rounded-md border',
      'bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-white',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'border-border border bg-white text-gray-900 shadow-md',
